...
data = moments.Spectrum.from_file('/scratch/user/uqkprat2/analysis/kp_dadi/data/fs/group3-Amil_projected0.8.fs')
ns = data.sample_sizes

p0 = [0.27101747783112945, 1.036031232526235, 4.7061021443897175, 19.295781347914538, 9.994019179082004, 0.03643398419246758, 0.13154186696229134]
