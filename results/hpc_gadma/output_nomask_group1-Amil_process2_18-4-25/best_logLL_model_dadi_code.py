...
data = dadi.Spectrum.from_file('/scratch/user/uqkprat2/analysis/kp_dadi/data/fs/group1-Amil_projected0.8.fs')
pts = [50, 70, 90]
ns = data.sample_sizes

p0 = [0.6325757144913919, 100.0, 4.9999999999999964, 1.0009992487626043, 12.67600232661748, 0.01340391940272825, 0.2401651478661203, 1.7119884440189093, 18.72275581391791, 11.167000825720043, 0.036750199539692545, 0.17324424942060565]
