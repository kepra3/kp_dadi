...
data = dadi.Spectrum.from_file('/scratch/user/uqkprat2/analysis/kp_dadi/data/fs/group2-Amil_projected0.8.fs')
pts = [50, 70, 90]
ns = data.sample_sizes

p0 = [0.9958998277510105, 0.9675190568402147, 3.1091574220684053, 1.2976478615678417, 16.352809116701415, 0.0, 0.0036628325518283625, 2.7150993847341063, 22.926636649946637, 10.901181797481797, 0.03032510117190137, 0.20339047257129406]
