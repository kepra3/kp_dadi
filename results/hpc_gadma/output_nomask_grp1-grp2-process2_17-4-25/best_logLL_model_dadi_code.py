...
data = dadi.Spectrum.from_file('/scratch/user/uqkprat2/analysis/kp_dadi/data/fs/group1-group2_projected0.8.fs')
pts = [50, 70, 90]
ns = data.sample_sizes

p0 = [1.768213308111729, 2.1056649086678885, 1.867224330307131, 0.7325839994154155, 9.513309945246345, 0.0, 0.16467323105334744, 2.0036569063477185, 22.05915444337313, 20.477609776796456, 0.07127807936333032, 0.4939708013939087]
