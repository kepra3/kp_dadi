...
data = dadi.Spectrum.from_file('/scratch/user/uqkprat2/analysis/kp_dadi/data/fs/group3-group4_projected0.8.fs')
pts = [50, 70, 90]
ns = data.sample_sizes

p0 = [1.0431097302928456, 4.029547271246914, 2.1566621779897766, 3.352927225551189, 34.56161565539901, 0.15624309622370072, 0.026161221550134093, 0.9820202005111647, 17.915096213721114, 28.295483623270762, 0.7975308729087035, 0.1341750412452649]
