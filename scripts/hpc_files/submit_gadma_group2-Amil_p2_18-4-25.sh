#!/bin/bash --login
#SBATCH --job-name="group2-Amil-gadma-p2"   	# job name
...
#SBATCH -o current_gadma-group2-Amil_p2_18-4-25_%A_%a.o # standard output
#SBATCH -e current_gadma-group2-Amil_p2_18-4-25_%A_%a.e # standard error
