...
#SBATCH -o current_gadma-group4-Amil_p1_30-5-25_%A_%a.o # standard output
#SBATCH -e current_gadma-group4-Amil_p1_30-5-25_%A_%a.e # standard error
...
gadma -p params-full-group4-Amil_process1
