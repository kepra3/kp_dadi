#!/bin/bash --login
#SBATCH --job-name="LRT-g4-amil_hetsc-og"
#SBATCH --nodes=1
...
#SBATCH -o LRT-g4-amil_hetsc-og_%A_%a.o
#SBATCH -e LRT-g4-amil_hetsc-og_%A_%a.e
...
python lrt_godambe.py group4-Amil_projected0.8 1het hetsc ../data/fs/projected_group4-Amil no \
  --opt_full 0.89495 200 1.53038 16.49094 5.4468 0.0261 0.09442 0.09761 17.63399 7.76057 1.4379 10 0.25806 0.57771 \
