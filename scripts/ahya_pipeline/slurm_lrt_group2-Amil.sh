...
#SBATCH -o LRT-g2-amil_%A_%a.o
#SBATCH -e LRT-g2-amil_%A_%a.e
...
python lrt_godambe.py group2-Amil_projected0.8 1het hetsc ../data/fs/projected_group2-Amil no \
  --opt_full 1.08452 23.36606 1.70979 16.60098 7.40507 0.02221 0.05167 0.06279 24.95252 31.37163 2.41537 15 0.32672 0.61179 \
